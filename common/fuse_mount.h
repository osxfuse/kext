...
#define FUSE_MOPT_DEFER_AUTH             0x0000000000000100ULL
#define FUSE_MOPT_DIRECT_IO              0x0000000000000200ULL
#define FUSE_MOPT_EXTENDED_SECURITY      0x0000000000000400ULL
#define FUSE_MOPT_FD                     0x0000000000000800ULL
#define FUSE_MOPT_FSID                   0x0000000000001000ULL
#define FUSE_MOPT_FSNAME                 0x0000000000002000ULL
#define FUSE_MOPT_FSSUBTYPE              0x0000000000004000ULL
#define FUSE_MOPT_GID                    0x0000000000008000ULL
#define FUSE_MOPT_HARD_REMOVE            0x0000000000010000ULL
#define FUSE_MOPT_INIT_TIMEOUT           0x0000000000020000ULL
#define FUSE_MOPT_IOSIZE                 0x0000000000040000ULL
#define FUSE_MOPT_JAIL_SYMLINKS          0x0000000000080000ULL
#define FUSE_MOPT_KERNEL_CACHE           0x0000000000100000ULL
#define FUSE_MOPT_KILL_ON_UNMOUNT        0x0000000000200000ULL
#define FUSE_MOPT_NO_ALERTS              0x0000000000400000ULL
#define FUSE_MOPT_NO_APPLEDOUBLE         0x0000000000800000ULL
#define FUSE_MOPT_NO_APPLEXATTR          0x0000000001000000ULL
#define FUSE_MOPT_NO_ATTRCACHE           0x0000000002000000ULL
#define FUSE_MOPT_NO_AUTH_OPAQUE         0x0000000004000000ULL
#define FUSE_MOPT_NO_AUTH_OPAQUE_ACCESS  0x0000000008000000ULL
#define FUSE_MOPT_NO_BROWSE              0x0000000010000000ULL
#define FUSE_MOPT_NO_LOCALCACHES         0x0000000020000000ULL
#define FUSE_MOPT_NO_READAHEAD           0x0000000040000000ULL
#define FUSE_MOPT_NO_SYNCONCLOSE         0x0000000080000000ULL

/* Next 32 bits */
#define FUSE_MOPT_NO_SYNCWRITES          0x0000000100000000ULL
#define FUSE_MOPT_NO_UBC                 0x0000000200000000ULL
#define FUSE_MOPT_NO_VNCACHE             0x0000000400000000ULL
#define FUSE_MOPT_READDIR_INO            0x0000000800000000ULL
#define FUSE_MOPT_ROOTMODE               0x0000001000000000ULL
#define FUSE_MOPT_UID                    0x0000002000000000ULL
#define FUSE_MOPT_UMASK                  0x0000004000000000ULL
#define FUSE_MOPT_USE_INO                0x0000008000000000ULL

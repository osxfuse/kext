...
#define FUSE_MOPT_NO_AUTH_OPAQUE         0x0000000000400000ULL
#define FUSE_MOPT_NO_AUTH_OPAQUE_ACCESS  0x0000000000800000ULL
#define FUSE_MOPT_NO_BROWSE              0x0000000001000000ULL
#define FUSE_MOPT_NO_LOCALCACHES         0x0000000002000000ULL
#define FUSE_MOPT_NO_READAHEAD           0x0000000004000000ULL
#define FUSE_MOPT_NO_SYNCONCLOSE         0x0000000008000000ULL
...
#define FUSE_MOPT_USE_INO                0x0000000800000000ULL

/* Next 32 bits */

#define FUSE_MOPT_VOLNAME                0x0000001000000000ULL
#define FUSE_MOPT_VOL_RENAME             0x0000002000000000ULL

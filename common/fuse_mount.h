...
#define FUSE_MOPT_NEGATIVE_VNCACHE       0x0000000000080000ULL
#define FUSE_MOPT_NO_ALERTS              0x0000000000100000ULL
#define FUSE_MOPT_NO_APPLEDOUBLE         0x0000000000200000ULL
#define FUSE_MOPT_NO_APPLEXATTR          0x0000000000400000ULL
#define FUSE_MOPT_NO_ATTRCACHE           0x0000000000800000ULL
...
#define FUSE_MOPT_NO_SYNCWRITES          0x0000000010000000ULL
#define FUSE_MOPT_NO_UBC                 0x0000000020000000ULL
#define FUSE_MOPT_NO_VNCACHE             0x0000000040000000ULL
#define FUSE_MOPT_USE_INO                0x0000000080000000ULL

/* Next 32 bits */
#define FUSE_MOPT_VOLNAME                0x0000000100000000ULL
#define FUSE_MOPT_VOL_RENAME             0x0000000200000000ULL
